...
library PositionValue {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        amount0 = (
            ((poolFeeGrowthInside0LastX128 - feeParams.positionFeeGrowthInside0LastX128) * feeParams.liquidity)
                / FixedPoint128.Q128
        ) + feeParams.tokensOwed0;

        amount1 = (
            ((poolFeeGrowthInside1LastX128 - feeParams.positionFeeGrowthInside1LastX128) * feeParams.liquidity)
                / FixedPoint128.Q128
