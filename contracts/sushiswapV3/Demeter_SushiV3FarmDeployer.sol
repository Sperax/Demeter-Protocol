...
import {Demeter_SushiV3Farm, RewardTokenData, SushiswapPoolData} from "./Demeter_SushiV3Farm.sol";
...
contract Demeter_SushiV3FarmDeployer is BaseFarmDeployer, ReentrancyGuard {
    ...
    // sushiswapPoolData - Init data for SushiswapV3 pool.
    ...
    struct FarmData {
        ...
        SushiswapPoolData sushiswapPoolData;
        RewardTokenData[] rewardData;
    }

    string public constant DEPLOYER_NAME = "Demeter_SushiV3FarmDeployer_v3";

    constructor(address _factory) BaseFarmDeployer() {
    ...
    /// @notice Deploys a new SushiswapV3 farm.
        ...
        returns (address)
    {
        ...
        _collectFee(
            _data.sushiswapPoolData.tokenA,
            _data.sushiswapPoolData.tokenB
        );
